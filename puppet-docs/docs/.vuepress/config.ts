...
export default defineUserConfig({
  ...
  head: [
    // 配置站点图标
    ['link', { rel: 'icon', type: 'image/x-icon', href: '/puppet.ico' }],
    ['link', { rel: 'icon', type: 'image/png', sizes: '32x32', href: '/puppet.png' }],
  ],
  ...
  theme: plumeTheme({
    ...
    hostname: 'https://puppet.ifiss.eu.org',

    /* 文档仓库配置，用于 editLink */
    docsRepo: 'https://github.com/bil-fis/puppet',
    docsDir: 'puppet-docs/docs',
    // docsBranch: '',
