...
<tr>
<td><code v-pre>StorageController</code></td>
<td>持久化存储（支持签名验证）</td>
<td><code v-pre>StorageController.cs</code></td>
</tr>
</tbody>
</table>
...
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666">[</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">PUP</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994"> V1</span><span style="--shiki-light:#999999;--shiki-dark:#666666">.</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">0 </span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">标识头</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE"> 8 </span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">字节</span><span style="--shiki-light:#999999;--shiki-dark:#666666">]</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676"> +</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> [</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">AES</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994"> 加密的</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994"> ZIP</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994"> 密码</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE"> 32 </span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">字节</span><span style="--shiki-light:#999999;--shiki-dark:#666666">]</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676"> +</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> [</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">ZIP</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994"> 数据</span><span style="--shiki-light:#999999;--shiki-dark:#666666">]</span></span>
<span class="line"><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">// PUP V1.1/V1.2 结构：</span></span>
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666">[</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">PUP</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994"> V1</span><span style="--shiki-light:#999999;--shiki-dark:#666666">.</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">1/</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">V1</span><span style="--shiki-light:#999999;--shiki-dark:#666666">.</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">2 </span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">标识头</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE"> 8 </span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">字节</span><span style="--shiki-light:#999999;--shiki-dark:#666666">]</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676"> +</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> [</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">脚本长度</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE"> 4 </span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">字节</span><span style="--shiki-light:#999999;--shiki-dark:#666666">]</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676"> +</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> [</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">脚本内容</span><span style="--shiki-light:#999999;--shiki-dark:#666666">]</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676"> +</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> [</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">证书长度</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE"> 4 </span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">字节</span><span style="--shiki-light:#999999;--shiki-dark:#666666">]</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676"> +</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> [</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">证书数据</span><span style="--shiki-light:#999999;--shiki-dark:#666666">]</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676"> +</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> [</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">加密私钥长度</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE"> 4 </span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">字节</span><span style="--shiki-light:#999999;--shiki-dark:#666666">]</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676"> +</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> [</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">加密私钥数据</span><span style="--shiki-light:#999999;--shiki-dark:#666666">]</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676"> +</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> [</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">加密密码</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE"> 32 </span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">字节</span><span style="--shiki-light:#999999;--shiki-dark:#666666">]</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676"> +</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> [</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">ZIP</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994"> 数据</span><span style="--shiki-light:#999999;--shiki-dark:#666666">]</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>解析自定义的 PUP 文件格式（支持 V1.0、V1.1、V1.2）</li>
<li>V1.2 格式支持加载证书和加密私钥</li>
<li>解密 ZIP 密钥</li>
<li>从内存中读取文件内容</li>
</ul>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="签名工具类-core-security" tabindex="-1"><a class="header-anchor" href="#签名工具类-core-security"><span>签名工具类（Core/Security/）</span></a></h4>
<p>位于 <code v-pre>Core/Security/</code> 目录下，提供完整的签名和验证功能：</p>
<ul>
<li><strong>AppSignatureValidator.cs</strong> - 数据库签名验证器</li>
<li><strong>CertificateUtils.cs</strong> - 证书工具类（证书导入、导出、验证）</li>
<li><strong>CryptoUtils.cs</strong> - 加密工具类（AES-256-GCM、PBKDF2 密钥派生）</li>
<li><strong>SecurityException.cs</strong> - 安全异常类</li>
</ul>
<p><strong>签名流程</strong>：</p>
<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code class="language-"><span class="line"><span>数据库内容 → SHA256 哈希 → RSA 私钥签名 → 存储到 puppet_metadata 表</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p><strong>验证流程</strong>：</p>
<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code class="language-"><span class="line"><span>数据库内容 → SHA256 哈希 → 证书公钥验证 → 对比签名数据</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h2 id="数据流详解" tabindex="-1"><a class="header-anchor" href="#数据流详解"><span>数据流详解</span></a></h2>
